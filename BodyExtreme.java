public class BodyExtreme {
    ...
    public BodyExtreme(double xxPos, double yyPos, double xxVel, double yyVel, double mass, String imgFileName) {
    ...
    public void update(double inc, double xxForce, double yyForce, BodyExtreme ship, boolean[] directions) {
        if (ship == this){
        ...
        this.xxVel = xxVel + inc*xxAccel;

        double yyAccel = yyForce/this.mass;
        this.yyVel = yyVel + inc*yyAccel;

        this.xxPos = xxPos + inc*xxVel;
        this.yyPos = yyPos + inc*yyVel;
    }
